...
public class Exercicio31 {
	public static void main(String[] args) {
		...
		System.out.println("Informe a quantidade em kilogramas da carne que você quer levar");
		float qtd = entrada.nextFloat();
		System.out.println("A compra será feita com o cartão Tabajara? (s - Sim | n - Não)");
